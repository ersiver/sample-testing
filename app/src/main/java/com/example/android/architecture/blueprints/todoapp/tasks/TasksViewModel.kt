...
class TasksViewModel(
    ...
    //For testing and architecture purposes, it's bad practice to construct the repository
    //here, so the below was deleted and we passed ref. to TasksRepository interface to the constructor:
...
// To avoid building a separate factories for each view model generic ViewModelFactory is created.
