 ...
 *
 * It demonstrates constructor dependency injection (tasksRemoteDataSource and
 * tasksLocalDataSource passed into the constructor as references to the TaskDataSource interface
 * can be easily swapped with FakeDataSource).
 * Constructor dependency injection is not the case for testing Fragments and Activities
 * since they can't be instantiated).
 */
